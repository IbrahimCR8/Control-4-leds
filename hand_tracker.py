...
# --- FIX: Make the window resizable ---
cv2.namedWindow("Hand Tracker UI", cv2.WINDOW_NORMAL)
...
while True:
    ...
    # Flip the image horizontally to correct Left/Right detection
    img = cv2.flip(img, 1)
    ...
    # Detect hands directly on the flipped frame
    ...
    if hands:
        ...
        # Invert the thumb logic because the image is flipped
